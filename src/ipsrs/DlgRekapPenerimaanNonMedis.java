...
//        this.setCursor(Cursor.getDefaultCursor());
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ...
                pilihan = (String) JOptionPane.showInputDialog(null, "Silahkan pilih laporan..!", "Pilihan Cetak", JOptionPane.QUESTION_MESSAGE, null, new Object[]{"Laporan 1 (Jasper)", "Laporan 2 (CSV)"}, "Laporan 1 (Jasper)");
                switch (pilihan) {
                    case "Laporan 1 (Jasper)":
                    ...
                    case "Laporan 2 (CSV)":
                        ...
                        htmlContent.append(
                                "\"No.Faktur\";\"No.Order\";\"Suplier\";\"Petugas\";\"Tgl.Pesan\";\"Tgl.Faktur\";\"Jatuh Tempo\";\"Nama Barang\";\"Satuan\";\"QTY\";\"Harga Beli(Rp)\";\"SubTotal(Rp)\";\"Disk(%)\";\"Bsr.Disk(Rp)\";\"Total(Rp)\";\"Status Bayar\"\n"
                        );
                        for (i = 0; i < tabMode.getRowCount(); i++) {
                            htmlContent.append(
                                    "\"" + tabMode.getValueAt(i, 0) + "\";\"" + tabMode.getValueAt(i, 1) + "\";\"" + tabMode.getValueAt(i, 2) + "\";\"" + tabMode.getValueAt(i, 3) + "\";\"" + tabMode.getValueAt(i, 4) + "\";\"" + tabMode.getValueAt(i, 5) + "\";\"" + tabMode.getValueAt(i, 6) + "\";\"" + tabMode.getValueAt(i, 7) + "\";\"" + tabMode.getValueAt(i, 8) + "\";\"" + tabMode.getValueAt(i, 9) + "\";\"" + tabMode.getValueAt(i, 10) + "\";\"" + tabMode.getValueAt(i, 11) + "\";\"" + tabMode.getValueAt(i, 12) + "\";\"" + tabMode.getValueAt(i, 13) + "\";\"" + tabMode.getValueAt(i, 14) + "\";\"" + tabMode.getValueAt(i, 15) + "\"\n"
                            );
                        }

                        f = new File("RekapPenerimaanNonmmedis.csv");
