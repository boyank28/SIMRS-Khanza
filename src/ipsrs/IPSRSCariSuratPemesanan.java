...
public class IPSRSCariSuratPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppSuratPemesanan.setText("Surat Pemesanan (PO)");
        ppSuratPemesanan.setToolTipText("");
        ...
        if (Apoteker.getText().trim().equals("")) {
            ...
            try {
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "surat_pemesanan_non_medis.tagihan,surat_pemesanan_non_medis.keterangan from surat_pemesanan_non_medis "
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                Sequel.menyimpan(
                                        ...
                                        + rs.getString("keterangan")+ "','','','','','','','','','','','','','','','','','','','','','','','','','','','" + akses.getalamatip() + "'", "Transaksi Pemesanan"
                                );
                                i++;
                            }
                        } catch (Exception e) {
                        ...
                        if (rs.getDouble("total") > 10000000) {
        ...
        try {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabMode.addRow(new Object[]{"Keterangan", ": " + rs.getString("keterangan") + " ", "", "", "", "", "PPN", ":", Valid.SetAngka(rs.getDouble("ppn"))});
